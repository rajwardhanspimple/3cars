export class RaceAudio {
 constructor(){this.ctx=null;this.muted=false;this.state={phase:'menu',rpm:900,speed:0,throttle:0,wet:false,slip:0,impact:0,gear:1,boostActive:false,drifting:false};this.lastImpact=0;this.lastGear=1;this.note=0;this.noteTime=0;this.notes=[392,494,587,659,587,494,440,494];this.nodes=[];this.unlocking=null;}
 async unlock(){
 ...
 async init(){
  ...
  try{
   ...
   this.engineGain=gain();this.tireGain=gain();this.driftGain=gain();this.rainGain=gain();this.boostGain=gain();this.musicGain=gain();this.fxGain=gain();
 ...
 apply(dt){
  ...
  this.setGain(this.boostGain,boost?Math.min(.12,.035+throttle*.035+speed*.00012):0,live,t,.035);
